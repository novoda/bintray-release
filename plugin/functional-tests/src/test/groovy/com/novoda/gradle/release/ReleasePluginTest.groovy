...
class ReleasePluginTest {
    ...
    static Collection<BuildConfiguration> configurations() {
        return [
                ...
                BuildConfiguration.forJava('4.0.2'),
                BuildConfiguration.forJava('4.1'),
                BuildConfiguration.forJava('4.2.1'),
                BuildConfiguration.forJava('4.3.1'),
                BuildConfiguration.forJava('4.4.1'),
                BuildConfiguration.forJava('4.5.1'),
                BuildConfiguration.forJava('4.6'),
                BuildConfiguration.forJava('4.7'),
                BuildConfiguration.forJava('4.8.1'),
                BuildConfiguration.forJava('4.9'),
                BuildConfiguration.forJava('4.10.3'),
                ...
                BuildConfiguration.forJava('5.5.1'),
                BuildConfiguration.forJava('5.6.4'),
                BuildConfiguration.forJava('6.0.1'),
                BuildConfiguration.forJava('6.1.1'),
