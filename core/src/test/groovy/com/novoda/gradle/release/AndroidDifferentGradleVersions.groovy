...
class AndroidDifferentGradleVersions {
    ...
    static Collection<GradleVerionsParams> gradleVersionExpectedOutcome() {
        return [
                // Gradle 4.4 is minimum version supported by the Android Gradle Plugin 3.1.0
                new GradleVerionsParams(gradleVersion: "4.0", expectedGradleBuildFailure: true),
                new GradleVerionsParams(gradleVersion: "4.1", expectedGradleBuildFailure: true),
                new GradleVerionsParams(gradleVersion: "4.2", expectedGradleBuildFailure: true),
                new GradleVerionsParams(gradleVersion: "4.3", expectedGradleBuildFailure: true),
